...
module.exports = {
    SESSION: process.env.BOBIZ_SESSION === undefined ? '' : process.env.SPIDER_SESSION,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'SPIDERBOT-MD  instagram.com/noureddine_ouafy تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶 𝚂𝙿𝙸𝙳𝙴𝚁 𝙱𝙾𝚃 𝙼𝙳 https://instagram.com/shikeo_sad?igshid=YmMyMTA2M2Y=  🐕' : process.env.CAPTION,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? 'SPIDER-MD' : process.env.STIC_WM,
};
